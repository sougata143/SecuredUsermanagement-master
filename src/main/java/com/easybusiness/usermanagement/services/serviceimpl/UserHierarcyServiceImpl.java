...
public class UserHierarcyServiceImpl implements UserHierarcyService {
    ...
    @RequestMapping(value = "getByHierarcyId/{hierarcyId}", method = RequestMethod.GET)
    @ResponseBody
...
//				hierarcyDTO.setGroupHead(groupHeadEntity.getFirstName()+" "+groupHeadEntity.getLastName());
	...
	@Override
	@CrossOrigin(origins = USER_HOST_SERVER)
    @RequestMapping(value = "addHierarcy", method = RequestMethod.POST)
    @ResponseBody
	...
	@Override
	@CrossOrigin(origins = USER_HOST_SERVER)
    @RequestMapping(value = "getAllHierarcy", method = RequestMethod.GET)
    @ResponseBody
	...
	@Override
	@CrossOrigin(origins = USER_HOST_SERVER)
    @RequestMapping(value = "deleteHierarcy/{hierarcyId}", method = RequestMethod.DELETE)
    @ResponseBody
	...
	@Override
	@CrossOrigin(origins = USER_HOST_SERVER)
    @RequestMapping(value = "updateHierarcy/{hierarcyId}", method = RequestMethod.PUT)
    @ResponseBody
...
//		List<UserHierarchy> hierarcyList = hierarcyDao.getAllHierarcy();
	...
	@Override
	@CrossOrigin(origins = USER_HOST_SERVER)
    @RequestMapping(value = "getGroupHead", method = RequestMethod.GET)
    @ResponseBody
